...
import io.space.mod.move.KeepSprint;
import io.space.mod.visual.AnimationSneak;
...
public abstract class EntityPlayer extends EntityLivingBase
{
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            ...
                            final boolean fix = this == Minecraft.getMinecraft().player && KeepSprint.Instance.isEnable();
    ...
    public void jump()
    {
        if (this == Minecraft.getMinecraft().player) {
            final EventJump eventJump = new EventJump();
    ...
    private float animationEyeHeight = 1.62F;
    ...
    public float getEyeHeight()
    {
        ...
        if (AnimationSneak.Instance.isEnable()) {
            if (this == Minecraft.getMinecraft().player) {
                animationEyeHeight = (float) RenderUtils.getAnimationStateEasing(animationEyeHeight, f, 0.6);
                return animationEyeHeight;
            }
        }
