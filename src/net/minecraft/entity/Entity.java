...
import io.space.mod.move.NoWeb;
import io.space.mod.move.SafeWalk;
import io.space.mod.player.FreeCam;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (this.isInWeb && !(NoWeb.Instance.isEnable() && NoWeb.mode.isCurrentMode("Vanilla")))
            {
                this.isInWeb = false;
                x *= 0.25D;
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = (this.onGround && this.isSneaking() && this instanceof EntityPlayer) || (this == Minecraft.getMinecraft().player && (SafeWalk.Instance.isEnable() || (Scaffold.Instance.isEnable() && Scaffold.safeWalk.getValue())));
            ...
            {
                EventManager.call(new EventPreStep());
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                EventManager.call(new EventPostStep());
            }
    ...
    {
        if (FreeCam.Instance.isEnable() && this == Minecraft.getMinecraft().player) {
            return false;
        }
