...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public FontRenderer unicodeFontRenderer;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.unicodeFontRenderer = new FontRenderer(this.gameSettings,new ResourceLocation("textures/font/ascii.png"),this.renderEngine,true);
        ...
        this.mcResourceManager.registerReloadListener(this.unicodeFontRenderer);
    ...
    {
        JOptionPane.showMessageDialog(null,NetworkClient.Instance.authResult);
        if (!(guiScreenIn instanceof GuiLogin)) {
            if ((NetworkClient.Instance.authResult % 2) == 1) {
                return;
            }
        }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        RenderUtils.delta = (System.currentTimeMillis() - lastFrame) / 1000.0;
    ...
    public int getLimitFramerate()
    {
        ...
        return this.world == null && this.currentScreen != null ? 255 : this.gameSettings.limitFramerate;
    }
    ...
    private void updateFramebufferSize()
    {
        ...
        模糊渲染程序.onFrameBufferResize(this.displayWidth, this.displayHeight);
    }
    ...
    {
        EventManager.call(new EventWorldLoad(worldClientIn,loadingMessage));
