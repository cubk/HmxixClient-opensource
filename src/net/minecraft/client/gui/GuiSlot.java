...
public abstract class GuiSlot
{
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_)
    {
        if (this.field_178041_q) {
            ...
            int scrollBarXWidth = scrollBarX + 6;
            this.bindAmountScrolled();
            ...
            if (j1 > 0)
            {
                ...
                worldrenderer.pos((double)scrollBarXWidth, (double)this.bottom, 0.0D).tex(1.0D, 1.0D).color(0, 0, 0, 255).endVertex();
                worldrenderer.pos((double)scrollBarXWidth, (double)this.top, 0.0D).tex(1.0D, 0.0D).color(0, 0, 0, 255).endVertex();
                ...
                worldrenderer.pos((double)scrollBarXWidth, (double)(l1 + k1), 0.0D).tex(1.0D, 1.0D).color(128, 128, 128, 255).endVertex();
                worldrenderer.pos((double)scrollBarXWidth, (double)l1, 0.0D).tex(1.0D, 0.0D).color(128, 128, 128, 255).endVertex();
                ...
                worldrenderer.pos((double)(scrollBarXWidth - 1), (double)(l1 + k1 - 1), 0.0D).tex(1.0D, 1.0D).color(192, 192, 192, 255).endVertex();
                worldrenderer.pos((double)(scrollBarXWidth - 1), (double)l1, 0.0D).tex(1.0D, 0.0D).color(192, 192, 192, 255).endVertex();
