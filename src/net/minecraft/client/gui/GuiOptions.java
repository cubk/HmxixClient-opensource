...
import io.space.renderer.gui.clientsetting.GuiClientSetting;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(114514, this.width / 2 - 155, this.height / 6 + 168 - 6,150, 20,"Client Setting"));
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 192, I18n.format("gui.done", new Object[0])));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if (button.id == 114514) {
                this.mc.gameSettings.saveOptions();
                mc.displayGuiScreen(new GuiClientSetting(this));
            }
        }
    }
