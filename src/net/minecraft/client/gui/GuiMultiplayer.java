...
import io.space.renderer.gui.serverlist.GuiServerList;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    private GuiButton fakeForgeButton;
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(94,2, this.height - 28, 75, 20,"服务器推荐"));
        this.buttonList.add(fakeForgeButton = new GuiButton(95,2, this.height - 50, 75, 20,"FakeForge: " + (GlobalSetting.Instance.getFakeForge().getValue() ? "开" : "关")));
        this.buttonList.add(new GuiButton(1337, 2, 2, 98, 20, ProtocolCollection.getProtocolById(ViaForge.getInstance().getVersion()).getName()));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 94) {
                mc.displayGuiScreen(new GuiServerList());
            }
            else if (button.id == 95) {
                GlobalSetting.Instance.getFakeForge().setValue(!GlobalSetting.Instance.getFakeForge().getValue());
                fakeForgeButton.displayString = "FakeForge: " + (GlobalSetting.Instance.getFakeForge().getValue() ? "开" : "关");
            }
