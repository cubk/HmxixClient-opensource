...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(114514, this.width / 2 - 100, this.height / 4 + 144 + i,"重新连接"));
        ...
        switch (button.id)
        {
            ...
            case 114514:
                if (!mc.isSingleplayer()) {
                    ...
                    mc.displayGuiScreen(new GuiConnecting(new GuiMultiplayer(new GuiMainMenu()),mc,Wrapper.Instance.getLastConnectedServer()));
                }
