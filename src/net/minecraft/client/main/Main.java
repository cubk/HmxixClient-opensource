...
public class Main
{
    ...
    public static void main(String[] p_main_0_) {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo(StringUtils.randomString(10,"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_"), new String[0]);
