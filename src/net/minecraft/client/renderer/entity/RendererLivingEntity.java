...
import io.space.mod.visual.EntityHurtColor;
import io.space.mod.visual.NameTags;
import io.space.mod.world.AntiInvisibility;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
        ...
        boolean flag1 = !flag && (!entitylivingbaseIn.isInvisibleToPlayer(Minecraft.getMinecraft().player) || AntiInvisibility.Instance.isEnable());
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures)
    {
        ...
        else
        {
            ...
            if (flag1)
            {
                if (EntityHurtColor.Instance.isEnable()) {
                    final ColorValue color = EntityHurtColor.color;
                    ...
                    this.brightnessBuffer.put(EntityHurtColor.alpha.getValue().floatValue() / 255.0F);
                } else {
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            {
                if (ModManager.Instance.getModEnable("NameTags")) {
