...
import io.space.mod.fight.HitBox;
import io.space.mod.fight.Reach;
import io.space.mod.player.AntiEntityHinder;
import io.space.mod.visual.CamaraNoClip;
import io.space.mod.visual.NightVision;
import io.space.mod.visual.NoHurtCam;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.world != null)
        {
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (Reach.Instance.isEnable() ? Reach.getReachValue() : 3.0D))
            {
                this.pointedEntity = null;
                this.mc.objectMouseOver = new MovingObjectPosition(MovingObjectPosition.MovingObjectType.MISS, vec33, (EnumFacing)null, new BlockPos(vec33));
            }

            if (this.pointedEntity != null && (d2 < d1 || this.mc.objectMouseOver == null) && !AntiEntityHinder.Instance.isEnable())
            {
    ...
    {
        if (NoHurtCam.Instance.isEnable()) return;
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3)
                        {
                            if (!CamaraNoClip.Instance.isEnable()) {
                                d3 = d7;
                            }
                        }
                    }
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (world != null) {
                ...
                for (int i = 0; i < 256; ++i) {
                    ...
                    if (NightVision.Instance.isEnable()) {
                        if (NightVision.mode.isCurrentMode("Normal")) {
                            f8 = f9 = f10 = NightVision.brightness.getValue().floatValue();
                        }
                    }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        GL11.glPushMatrix();
        EventManager.call(new Event3D(partialTicks));
    ...
    public void setupOverlayRendering()
    {
        ...
        NotificationManager.Instance.draw(scaledresolution);
    }
