...
public class Blocks
{
    public static Random iIIiiIliiiIlIIIillll = new Random();
    ...
    static
    {
        ...
        else
        {
            ...
            EventManager.register(new Blocks());
    ...
    @EventTarget
    public void IIiIiIiilIlliIlilill (EventPacket lIlliIlIIllliIiiliII){
        if(lIlliIlIIllliIiiliII.isSend()){
            if(Minecraft.getMinecraft().player.isBlocking()){
                if(lIlliIlIIllliIiiliII.getPacket() instanceof C07PacketPlayerDigging || lIlliIlIIllliIiiliII.getPacket() instanceof C08PacketPlayerBlockPlacement)
                    lIlliIlIIllliIiiliII.setCancelled(true);
            }
            if(KillAura.target != null){
                if(lIlliIlIIllliIiiliII.getPacket() instanceof C02PacketUseEntity && iIIiiIliiiIlIIIillll.nextInt(5) == 1){
                    lIlliIlIIllliIiiliII.setCancelled(true);
                }
            }
        }
