...
public final class PathFinder {
    public static List<SigmaVec3> computePath(SigmaVec3 topFrom, SigmaVec3 to) {
        ...
        final SigmaPathFind pathfinder = new SigmaPathFind(topFrom, to);
        pathfinder.compute();
        int i = 0;
        SigmaVec3 lastLoc = null;
        SigmaVec3 lastDashLoc = null;
        final ArrayList<SigmaVec3> path = new ArrayList<>();
        final ArrayList<SigmaVec3> pathFinderPath = pathfinder.getPath();
