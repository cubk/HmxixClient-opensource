...
public abstract class GuiAltLogin extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        switch (button.id) {
            ...
            case 2:
                ...
                break;
            case 1145:
                this.username.setText(StringUtils.randomString(10, Wrapper.Instance.getStringRandomSeed()));
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawCenteredString("Alt Login", (float)(this.width / 2), 20.0F, -1);
        Minecraft.getMinecraft().fontRenderer.drawCenteredString(status, (float) (this.width / 2), 29.0F, -1);
        ...
        if (this.combined.getText().isEmpty() && !this.combined.isFocused()) {
            Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("Email:Password", (float)(this.width / 2 - 96), 146.0F, -7829368);
        }
